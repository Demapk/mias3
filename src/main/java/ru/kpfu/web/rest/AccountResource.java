...
import ru.kpfu.service.dto.UserDTO;
import ru.kpfu.web.rest.errors.*;
import ru.kpfu.web.rest.vm.KeyAndPasswordVM;
...
//        User user = userService.registerUser(managedUserVM, managedUserVM.getPassword());
        User user = userService.registerUser(managedUserVM, managedUserVM.getPassword(), managedUserVM.getPatronymic());
