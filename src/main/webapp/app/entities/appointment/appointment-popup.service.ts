            ...
            if (id) {
                this.appointmentService.find(id)
                    .subscribe((appointmentResponse: HttpResponse<Appointment>) => {
                        const appointment: Appointment = appointmentResponse.body;
                        appointment.startTime = this.datePipe
                            .transform(appointment.startTime, 'yyyy-MM-ddTHH:mm:ss');
                        appointment.endTime = this.datePipe
                            .transform(appointment.endTime, 'yyyy-MM-ddTHH:mm:ss');
